...
html_context = {'display_github': True, 'github_user': 'm3y54m', 'github_repo': 'sphinx-doc-template', 'github_version': 'main/sample-docs/', 'github_root_dir': 'main/src', 'current_version': 'latest', 'latest_version': 'latest', 'available_versions': ('latest', ), 'css_files': (), }
...
htmlhelp_basename = 'sphinx-doc-template'
...
latex_documents = [
    (master_doc, 'sphinx-doc-template.tex', project,
     author, 'manual', 1),
]
...
man_pages = [
    (master_doc, 'sphinx-doc-template', project,
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sphinx-doc-template', project,
     author, 'sphinx-doc-template', 'One line description of project.',
     'Miscellaneous'),
]
